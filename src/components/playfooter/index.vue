...
<style scoped>
    ...
    .nav-btn-items .audio-control .audio-pause{
        width:0;
        height:0;
         border-width:0.4rem 0 0.4rem 0.6rem;
        margin-left: 0.2rem;
        border-style:solid;
        border-color:transparent transparent transparent #c62f2f;
    }
    .nav-btn-items .audio-control .audio-playing {
        width: 0.2rem;
        height: 1rem;
    ...
    .playingList:before,.playingList:after {
        content: '';
        position:absolute;
    }
    .playingList,.playingList:before,.playingList:after{
        display: block;
        width:0.2rem;
        height:0.2rem;
        border-width:0 1rem 0 0.2rem;
    ...
    .next-line,.next-line:before,.next-line:after{
        height:2px;
